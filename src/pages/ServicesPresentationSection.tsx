    ...
    <>
      ...
      >
        ...
        >
          ...
          <Box>
            <HStack spacing={20} mt={{ base: 14, lg: 0 }}>
              <Text fontSize={{ base: 30, lg: 35, xl: 40 }}>
                Planos de Saúde
              </Text>
              <Text fontSize={{ base: 18, lg: 20, xl: 30 }}>
                Desconto em energia
              </Text>
            </HStack>
            ...
            <HStack spacing={{ base: 0, md: 20 }} mt={{ base: 14, lg: 0 }}>
              <Text fontSize={{ base: 18, lg: 20, xl: 30 }}>
                Seguro de casa
              </Text>
              <Text fontSize={{ base: 30, lg: 35, xl: 40 }}>Consórcio</Text>
            </HStack>
            ...
            <HStack spacing={20} mt={{ base: 14, lg: 0 }} justify="flex-end">
              <Text fontSize={{ base: 18, lg: 20, xl: 30 }}>
                Plano de Saúde
              </Text>
              <Text fontSize={{ base: 30, lg: 35, xl: 40 }}>Financiamento</Text>
            </HStack>
